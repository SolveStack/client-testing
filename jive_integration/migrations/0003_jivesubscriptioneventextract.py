        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "peerlogic_call_id",
                    models.CharField(
                        blank=True, db_index=True, default="", max_length=22
                    ),
                ),
                (
                    "peerlogic_call_partial_id",
                    models.CharField(
                        blank=True, db_index=True, default="", max_length=22
                    ),
                ),
                ...
                (
                    ...
                    django_userforeignkey.models.fields.UserForeignKey(
                        ...
                        related_name="jivesubscriptioneventextract_created",
                ...
                (
                    ...
                    django_userforeignkey.models.fields.UserForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="jivesubscriptioneventextract_modified",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="The user that is automatically assigned",
                    ),
                ),
