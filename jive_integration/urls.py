...
jive_integration_root_router.register(
    r"jive-api-credentials", JiveAPICredentialsViewSet, basename="jive-api-credentials"
)
jive_integration_root_router.register(
    r"recording-buckets", JiveAWSRecordingBucketViewSet, basename="recording-buckets"
)

jive_api_credentials_router = routers.NestedSimpleRouter(
    jive_integration_root_router, r"jive-api-credentials", lookup="jive_api_credentials"
)
jive_api_credentials_router.register(
    r"channels", JiveChannelViewSet, basename="jive_api_credentials-channels"
)
...
urlpatterns = [
    path(
        "auth/connect-url",
        authentication_connect_url,
        name="authentication-connect-url",
    ),
